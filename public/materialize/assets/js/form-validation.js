...
document.addEventListener('DOMContentLoaded', function (e) {
    (function () {
        ...
        if (formValidationExamples) {
            // The element with ID "formValidationExamples" exists
            ...
            if (formValidationSelect2Ele) {
                // The element with name "formValidationSelect2" exists
                const formValidationSelect2ElejQuery = jQuery(formValidationSelect2Ele);
                // Select2 (Country)
                ...
                console.error('Element with name "formValidationSelect2" not found.');
            }

            const formValidationTechEle = formValidationExamples.querySelector('[name="formValidationTech"]');
            if (formValidationTechEle) {
                // The element with name "formValidationTech" exists
                const formValidationTechElejQuery = jQuery(formValidationTechEle);
                // Continue with the rest of the code
                //Bootstrap select
                ...
                console.error('Element with name "formValidationTech" not found.');
            }

            const formValidationLangEle = formValidationExamples.querySelector('[name="formValidationLang"]');
            if (formValidationLangEle) {
                // The element with name "formValidationLang" exists
                // Continue with the rest of the code
                ...
                console.error('Element with name "formValidationLang" not found.');
            }

            const formValidationHobbiesEle = formValidationExamples.querySelector('[name="formValidationHobbies"]');
            if (formValidationHobbiesEle) {
                // The element with name "formValidationHobbies" exists
                const formValidationHobbiesElejQuery = jQuery(formValidationHobbiesEle);
                // Continue with the rest of the code
                ...
                console.error('Element with name "formValidationHobbies" not found.');
            }
        }
