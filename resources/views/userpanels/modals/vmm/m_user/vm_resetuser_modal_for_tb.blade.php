...
<div class="modal fade" id="resetUserModalTB" data-bs-backdrop="false" tabindex="-1">
        ...
        <div class="modal-content p-3 p-md-1 pt-md-5">
            <div class="modal-body py-3 py-md-0">
                ...
                <div class="text-center mb-4">
                    <h3 class="mb-2">Confirm Users Reset</h3>
                </div>
                <form class="row g-2 needs-validation" method="POST"
                    action="{{ route('m-ul-data.reset') }}"
                    novalidate>
                    @csrf
                    <h6 class="text-center">
                        Are you sure want to <a class="text-warning">reset all of users records?</a> This action <a class="text-danger">cannot be undone</a>. <br>
                        ...
                        <div class="col-12 text-center">
                            <div class="d-flex flex-col justify-content-end">
                                <button class="modal-btn modal-mark-map-cancel-btn btn btn-primary me-2"
                                    id="cancel_modalresetUserModalTB" data-bs-dismiss="modal"
                                    type="button">Cancel</button>
                                <button class="modal-btn modal-users-tb-reset-btn btn btn-danger" type="submit"
