...
<div class="modal fade" id="deleteImageModalTB" data-bs-backdrop="false" tabindex="-1">
        ...
        <div class="modal-content p-3 p-md-1 pt-md-5">
            <div class="modal-body py-3 py-md-0">
                ...
                <div class="text-center mb-4">
                    <h3 class="mb-2">Confirm Image Deletion</h3>
                </div>
                <form id="addMarkFormMAPS" class="row g-2 needs-validation" method="POST"
                    action="{{ route('m-image-data.delete') }}"
                    novalidate>
                    @csrf
                        ...
                        <div class="col-12 text-center">
                            <div class="d-flex flex-col justify-content-end">
                                <button class="modal-btn modal-mark-map-cancel-btn btn btn-primary me-2"
                                    id="cancel_modaldeleteImageModalTB" data-bs-dismiss="modal"
