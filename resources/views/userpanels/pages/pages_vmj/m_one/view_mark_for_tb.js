document.addEventListener('DOMContentLoaded', function () {
    const modalId = 'viewMarkUserModal';
    const modalSelector = document.getElementById(modalId);
    const modalToShow = new bootstrap.Modal(modalSelector);
    const targetedModalForm = document.querySelector('#' + modalId + ' #viewMarkForm');
    ...
    const editCancelBtn = document.querySelector('#'+modalId+ ' #viewMarkForm .modal-mark-cancel-btn');
