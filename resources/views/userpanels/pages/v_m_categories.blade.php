                                ...
                                <tbody>
                                    @foreach ($loadCategoriesFromDB as $index => $cat)
                                        <tr>
                                            ...
                                            <td>{{ $index + 1 }}</td>
                                            <td>{{ $cat->cat_name }}</td>
                                            <td>{{ \Carbon\Carbon::parse($cat->created_at)->isoFormat('dddd, DD MMMM YYYY, h:mm:ss A') }}
                                            </td>
                                            <td>{{ \Carbon\Carbon::parse($cat->updated_at)->isoFormat('dddd, DD MMMM YYYY, h:mm:ss A') }}
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
