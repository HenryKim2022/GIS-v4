                                    ...
                                    <div class="col-12 mt-1">
                                        ...
                                        <div class="w-100">
                                            <input id="searchLeafletField" class="form-control typeahead-multi-datasets"
                                                type="text" autocomplete="off" placeholder="e.g jl/ jalan/ 1/ -" />
...
@section('footer_page_js')
    ...
    @endphp
    @if (count($errorMessageInputs) > 0)
        @foreach ($errorMessageInputs as $input)
            <input type="hidden" class="error-message" data-delay="{{ $input['delay'] }}"
                value="{{ $input['message'] }}">
        @endforeach
    @endif
    <script>
        $(document).ready(function() {
            try {
                ...
                console.log('This page has no in-page validation!');
            }
        });
    </script> --}}
